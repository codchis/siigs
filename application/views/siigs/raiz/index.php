...
<?php foreach ($raices as $raiz_item): ?>
	<tr>
		<td><?php echo $raiz_item->descripcion ?></td>
                <td><input hidden id="test" value=""/><a id="detalles" href="/<?php echo DIR_TES?>/tree/create/Arbol ASU/Arbol ASU/1/none/0/test/umt/<?php echo $raiz_item->id; ?>/1/<?php echo urlencode(json_encode(array(null)));?>/<?php echo urlencode(json_encode(array(null)));?>" id="fba1" class="btn btn-primary">Ver Arbol</a></div></td>
