...
<?php if($opcion_insert) { ?><a href="/<?php echo DIR_SIIGS?>/grupo/insert" class="btn btn-small btn-primary btn-icon">Crear nuevo <i class="icon-plus"></i></a><?php } ?>
...
<tbody>
	...
	<tr>
		<?php if($permiso_index) { ?><td><a href="/<?php echo DIR_SIIGS?>/grupo/<?php echo $group_item->id ?>/permiso" class="btn btn-small btn-primary btn-icon">Permisos <i class="icon-pencil"></i></a></td><?php } ?>
